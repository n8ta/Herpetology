...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/buttons.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/javascript/packs/buttons.js":
/*!*****************************************!*\
  !*** ./app/javascript/packs/buttons.js ***!
  \*****************************************/
...
!function () {
  ...
  var e = window.document,
      ...
      r = window.decodeURIComponent,
      n = window.Math,
      a = window.HTMLElement,
      i = window.XMLHttpRequest,
      l = "https://buttons.github.io/buttons.html",
      c = i && i.prototype && "withCredentials" in i.prototype,
      d = c && a && a.prototype.attachShadow && !a.prototype.attachShadow.prototype,
      s = function s(e, t, o) {
    e.addEventListener ? e.addEventListener(t, o) : e.attachEvent("on" + t, o);
  },
      u = function u(e, t, o) {
    e.removeEventListener ? e.removeEventListener(t, o) : e.detachEvent("on" + t, o);
  },
      h = function h(e, t, o) {
    var r = function r(n) {
      return u(e, t, r), o(n);
    ...
    s(e, t, r);
      ...
      f = function f(e, t, o) {
    var r = function r(n) {
      if (t.test(e.readyState)) return u(e, "readystatechange", r), o(n);
    };
    ...
    return function (t, o, r) {
      ...
      if (r) for (var l = 0, c = r.length; l < c; l++) {
        var d = r[l];
    ...
    n.styleSheet ? n.styleSheet.cssText = m : n.appendChild(e.ownerDocument.createTextNode(m));
    var a,
        l,
        d = r("a", {
      className: "btn",
      href: t.href,
      target: "_blank",
      innerHTML: (a = t["data-icon"], l = /^large$/i.test(t["data-size"]) ? 16 : 14, a = ("" + a).toLowerCase().replace(/^octicon-/, ""), v.hasOwnProperty(a) || (a = "mark-github"), '<svg version="1.1" width="' + l * v[a].width / v[a].height + '" height="' + l + '" viewBox="0 0 ' + v[a].width + " " + v[a].height + '" class="octicon octicon-' + a + '" aria-hidden="true">' + v[a].path + "</svg>"),
      "aria-label": t["aria-label"] || void 0
    }, [" ", r("span", {}, [t["data-text"] || ""])]);
    /\.github\.com$/.test("." + d.hostname) ? /^https?:\/\/((gist\.)?github\.com\/[^\/?#]+\/[^\/?#]+\/archive\/|github\.com\/[^\/?#]+\/[^\/?#]+\/releases\/download\/|codeload\.github\.com\/)/.test(d.href) && (d.target = "_top") : (d.href = "#", d.target = "_self");
    var u,
        h,
        g,
        x,
        y = e.appendChild(r("div", {
      className: "widget" + (/^large$/i.test(t["data-size"]) ? " lg" : "")
    }, [d]));
    /^(true|1)$/i.test(t["data-show-count"]) && "github.com" === d.hostname && (u = d.pathname.replace(/^(?!\/)/, "/").match(/^\/([^\/?#]+)(?:\/([^\/?#]+)(?:\/(?:(subscription)|(fork)|(issues)|([^\/?#]+)))?)?(?:[\/?#]|$)/)) && !u[6] ? (u[2] ? (h = "/repos/" + u[1] + "/" + u[2], u[3] ? (x = "subscribers_count", g = "watchers") : u[4] ? (x = "forks_count", g = "network") : u[5] ? (x = "open_issues_count", g = "issues") : (x = "stargazers_count", g = "stargazers")) : (h = "/users/" + u[1], g = x = "followers"), function (e, t) {
      var o = w[e] || (w[e] = []);

      if (!(o.push(t) > 1)) {
        var r = b(function () {
          for (delete w[e]; t = o.shift();) {
        ...
        if (c) {
          ...
          s(l, "load", d), s(l, "error", d), l.readyState && f(l, /de|m/, d), a.document.getElementsByTagName("head")[0].appendChild(l);
        }
      }
    }.call(this, "https://api.github.com" + h, function (e, t) {
      if (!e) {
        var n = t[x];
        y.appendChild(r("a", {
        ...
        }, [r("b"), r("i"), r("span", {}, [("" + n).replace(/\B(?=(\d{3})+(?!\d))/g, ",")])]));
      }
      ...
      C = function C(e) {
    return (y > 1 ? n.ceil(n.round(e * y) / y * 2) / 2 : n.ceil(e)) || 0;
  },
      F = function F(e, t) {
    e.style.width = t[0] + "px", e.style.height = t[1] + "px";
  },
      k = function k(t, r) {
    if (null != t && null != r) if (t.getAttribute && (t = function (e) {
      for (var t = {
        href: e.href,
        title: e.title,
        "aria-label": e.getAttribute("aria-label")
      }, o = ["icon", "text", "size", "show-count"], r = 0, n = o.length; r < n; r++) {
        var a = "data-" + o[r];
      ...
      var c = function c() {
        ...
        u(i, "load", c), x.call(d, a, t, function (e) {
          var a = function (e) {
            var t = e.offsetWidth,
                o = e.offsetHeight;
            ...
            if (e.getBoundingClientRect) {
              ...
              t = n.max(t, C(r.width)), o = n.max(o, C(r.height));
            }

            return [t, o];
          }(e);

          i.parentNode.removeChild(i), h(i, "load", function () {
            F(i, a);
          }), i.src = l + "#" + (i.name = function (e) {
            var t = [];

            for (var r in e) {
              var n = e[r];
              null != n && t.push(o(r) + "=" + o(n));
            }
      ...
      s(i, "load", c), e.body.appendChild(i);
    }
  };

  t.protocol + "//" + t.host + t.pathname === l ? x(e.body, function (e) {
    for (var t = {}, o = e.split("&"), n = 0, a = o.length; n < a; n++) {
      var i = o[n];

      if ("" !== i) {
        var l = i.split("=");
        t[r(l[0])] = null != l[1] ? r(l.slice(1).join("=")) : void 0;
      }
    }

    return t;
  }(window.name || t.hash.replace(/^#/, ""))) : function (t) {
    if (/m/.test(e.readyState) || !/g/.test(e.readyState) && !e.documentElement.doScroll) setTimeout(t);else if (e.addEventListener) {
      var o = b(t);
      h(e, "DOMContentLoaded", o), h(window, "load", o);
    } else f(e, /m/, t);
  }(function () {
    for (var t = e.querySelectorAll ? e.querySelectorAll("a.github-button") : function () {
      for (var t = [], o = e.getElementsByTagName("a"), r = 0, n = o.length; r < n; r++) {
        ~(" " + o[r].className + " ").replace(/[ \t\n\f\r]+/g, " ").indexOf(" github-button ") && t.push(o[r]);
      }
...
/******/ });
//# sourceMappingURL=buttons-e5c18c1c744bccf0272b.js.map