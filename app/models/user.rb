class User < ApplicationRecord
  ...
  has_many :reports, foreign_key: "created_by" # Column name on report, there a handled_by user and a created_By user
  ...
  def place_report_scoreboard
    User.all.sort {|a, b| b.approved_reports.size <=> a.reports.approved_reports.size }.find_index(self) + 1
  end
